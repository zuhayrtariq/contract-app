...
import { useDeleteRequisitionMutation, useGetAllContractsQuery, useGetAllContractsWithCoffQuery, useGetAllRequisitionsQuery, useGetContractsQuery } from '../../store/store';
...
const [colDefs, setColDefs] = useState([
  ...
  { headerName: "Requisition No.", field: 'reqNo',filter:'agTextColumnFilter', minWidth: 160,
  cellRenderer: ReqNoCell
  },
  { headerName: "Title", field: 'title',filter:'agTextColumnFilter', minWidth: 300,},
  { headerName: "Vendor Name", field: 'vendorName',filter:'agTextColumnFilter', minWidth: 180, },
  { headerName: "Buyer ", field: 'buyerName',filter: 'agTextColumnFilter',minWidth: 120, },
  { headerName: "Req Date", field: 'reqDate',filter: 'agTextColumnFilter',minWidth: 120,  valueFormatter:(x)=>{
    
    return convertDateMMMFormat(x.value)
  } },
 
  { headerName: "Type", field: 'reqType',filter: 'agTextColumnFilter',minWidth: 120, },
 
  { headerName: "Requisition ACV ($)", field: 'reqACV',filter:'agNumberColumnFilter', valueFormatter : (x)=>{
...
if(showColumn)
{
  ...
  return (
    <div className='w-full mr-4'>
      ...
      <input type="text" value={searchFilter} onChange={(e)=>{setSearchFilter(e.target.value)}} placeholder="Filter..." className="input input-bordered w-[200px] my-2 input-sm" />
