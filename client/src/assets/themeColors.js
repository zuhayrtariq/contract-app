async function extractThemeColorsFromDOM() {
	const computedStyles = await getComputedStyle(document.querySelector(':root'));
	return {
...
const callFunc = await extractThemeColorsFromDOM();
